...
// ── Empty form ────────────────────────────────────────────────────────────────
const EMPTY = { nom: "", club: "", pays: "", poste: "", email: "", telephone: "", linkedin: "", lien: "" };
...
function ContactFormModal({ open, onClose, initial, onSave }) {
  ...
  const handleSave = () => {
    if (!form.nom.trim() || !form.club.trim()) return;
    onSave(form);
  };
      ...
      <DialogContent className="max-w-lg">
        ...
        <div className="grid grid-cols-2 gap-3 py-2">
          ...
          <div className="col-span-2">
            ...
            <Input placeholder="ex: Directeur sportif, CEO, Agent…" value={form.poste} onChange={set("poste")} />
          </div>
          <div>
          ...
          <div>
            <Label className="text-xs text-slate-500 mb-1 block">Téléphone / WhatsApp</Label>
        ...
        <DialogFooter>
          ...
          <Button onClick={handleSave} disabled={!form.nom.trim() || !form.club.trim()}>
