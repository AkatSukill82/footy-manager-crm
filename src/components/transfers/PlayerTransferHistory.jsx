...
export default function PlayerTransferHistory({ player, transfers }) {
  ...
  const totalTransferValue = playerTransfers.reduce((sum, t) => sum + (t.montant || 0), 0);
    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          Historique des transferts - {player.nom}
        </CardTitle>
      </CardHeader>
      <CardContent>
        {playerTransfers.length === 0 ? (
          <p className="text-center text-slate-500 py-8">Aucun transfert enregistré</p>
        ) : (
          <div className="space-y-6">
            <div className="grid grid-cols-3 gap-4 pb-4 border-b border-slate-200">
              <div className="text-center">
                ...
                <div className="text-sm text-slate-600 mt-1">Transferts</div>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-slate-600 mt-1">Moyenne</div>
              </div>
            </div>
                    ...
                    {transfer.montant && (
                      <div className="mt-3 pt-3 border-t border-slate-200">
                        <div className="flex justify-between items-center">
                          <span className="text-sm text-slate-600">Montant du transfert:</span>
